...
app.setDefault = function(key, value) {
    defaults[key] = value;
};
...
app.init = function(options) {
    ...
    this.server.on('message', function(buffer, requestInfo) {
        ...
        app.parsePacket(buffer, function(packet) {
...
app.deflate = function(buffer, callback) {
...
app.inflate = function(buffer, callback) {
    if (defaults.useCompression) {
...
app.parsePacket = function(buffer, callback) {
...
app.decrypt = function(buffer, crcSeed) {
...
app.encrypt = function(buffer, crcSeed) {
...
app.appendCRC = function(buffer) {
    return new Buffer(buffer.toString('hex') + getCRC(buffer), 'hex');
};

app.checkAndRemoveCRC = function(buffer) {
